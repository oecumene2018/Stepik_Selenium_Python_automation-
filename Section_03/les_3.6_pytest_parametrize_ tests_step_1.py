...
#  Это касается только строковых значений, однако как оказалось туда можно передать любой объект в том числе и словарь,
#  а в последствии распаковать его значения и ключи. В общем крайне полезная фича
